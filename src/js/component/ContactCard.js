						...
						<li className="list-group-item" key={index}>
							<div className="row w-100">
								...
								<div className="col-12 col-sm-6 col-md-9 text-center text-sm-left">
									...
									<span className="text-seondary">{e.address}</span>
									<br />
									<i className="fa fa-phone fa-fw text-muted mr-3" />
									<span className="text-secondary small">{e.phone}</span>
									<br />
									<i
										...
										title=""
									/>
									<span className="text-secondary small text-truncate">{e.email}</span>
								</div>
							</div>
						</li>
					);
